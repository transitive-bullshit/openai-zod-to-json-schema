...
import { getRefs, parseUnionDef } from '..'
import { assert } from '../_utils'

describe('Unions', () => {
  test('Should be possible to get a simple type array from a union of only unvalidated primitives', () => {
  ...
  test('Should be possible to get a simple type array with enum values from a union of literals', () => {
    const parsedSchema = parseUnionDef(
      z.union([
        z.literal('string'),
        z.literal(123),
  ...
  test('Should be possible to create a union with objects, arrays and validated primitives as an anyOf', () => {
    const parsedSchema = parseUnionDef(
      z.union([
  ...
  test('should be possible to deref union schemas', () => {
  ...
  test('nullable primitives should come out fine', () => {
  ...
  test('should join a union of Zod enums into a single enum', () => {
  ...
  test('should work with discriminated union type', () => {
  ...
  test('should not ignore descriptions in literal unions', () => {
    assert(
      [
        parseUnionDef(
