...
import { getRefs, parseArrayDef } from '..'
import { assert } from '../_utils'
import { errorReferences } from './error-references'

describe('Arrays and array validations', () => {
  test('should be possible to describe a simple array', () => {
  ...
  test('should be possible to describe a simple array with any item', () => {
  ...
  test('should be possible to describe a string array with a minimum and maximum length', () => {
  ...
  test('should be possible to describe a string array with an exect length', () => {
    const parsedSchema = parseArrayDef(
  ...
  test('should be possible to describe a string array with a minimum length of 1 by using nonempty', () => {
    const parsedSchema = parseArrayDef(
  ...
  test('should be possible do properly reference array items', () => {
  ...
  test('should include custom error messages for minLength and maxLength', () => {
  ...
  test('should include custom error messages for exactLength', () => {
  ...
  test('should not include errorMessages property if none are passed', () => {
    const jsonSchema: JSONSchema7Type = {
      type: 'array',
      minItems: 5,
      maxItems: 10
  ...
  test("should not include error messages if it isn't explicitly set to true in References constructor", () => {
    const zodSchemas = [
