...
import { getRefs, parseNumberDef } from '..'
import { assert } from '../_utils'
import { errorReferences } from './error-references.js'

describe('Number validations', () => {
  test('should be possible to describe minimum number', () => {
  ...
  test('should be possible to describe maximum number', () => {
  ...
  test('should be possible to describe both minimum and maximum number', () => {
  ...
  test('should be possible to describe an integer', () => {
  ...
  test('should be possible to describe multiples of n', () => {
    const parsedSchema = parseNumberDef(
  ...
  test('should be possible to describe positive, negative, nonpositive and nonnegative numbers', () => {
    const parsedSchema = parseNumberDef(
  ...
  test("should include custom error messages for inclusive checks if they're passed", () => {
  ...
  test("should include custom error messages for exclusive checks if they're passed", () => {
  ...
  test("should include custom error messages for multipleOf and int if they're passed", () => {
  ...
  test("should not include errorMessage property if they're not passed", () => {
  ...
  test("should not include error messages if error message isn't explicitly set to true in References constructor", () => {
    const zodNumberSchemas = [
      z.number().lt(5),
      z.number().gt(5),
      z.number().gte(5),
